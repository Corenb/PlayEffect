  ...
  implements CommandExecutor
{
  ...
  public void onEnable()
  {
    ...
    getLogger().info("PlayEffect correctly enabled!")
  }
  
  public void onDisable()
  {
    this.effects = null;
    getLogger().info("PlayEffect correctly disabled!")
  }
  ...
  public class PlayerEffect
  {
    ...
    public PlayerEffect(Effect effect, int id, int data, float offsetX, float offsetY, float offsetZ, float speed, int count, int radius)
    {
      this.effect = effect;
      this.id = id;
      this.data = data;
    ...
    {
      loc.getWorld().spigot().playEffect(loc.add(loc.getDirection().clone().setY(0).normalize().multiply(3)), this.effect, this.id, this.data, this.offsetX, this.offsetY, this.offsetZ, this.speed, this.count, this.radius);
    }
  }
}
